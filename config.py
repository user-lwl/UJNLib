...
识别验证码超级鹰
账号信息
soft_id为软件ID，用户中心>>软件ID 生成一个替换
'''
ACCOUNT_CHAOJIYING = {'user_name': 'xxx', 'password': 'xxx', 'soft_id': 'xxx'}


'''
预约账号
预约指定座位号 seat_nos，以小写逗号隔开，不要有空格；如果无指定，留空即可
'''
ACCOUNTS = [
    {'cert_no': '', 'pwd': '', 'name': '', 'seat_nos': ''},
]
